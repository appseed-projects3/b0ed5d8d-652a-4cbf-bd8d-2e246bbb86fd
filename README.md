...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 18:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b0ed5d8d-652a-4cbf-bd8d-2e246bbb86fd.git
$ cd b0ed5d8d-652a-4cbf-bd8d-2e246bbb86fd
```
